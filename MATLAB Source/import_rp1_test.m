function [adata_out, cdata_out] = import_rp1_test()
%IMPORT_RP1_TEST Summary of this function goes here
%   Detailed explanation goes here
adata = import_155_data('analog-test-data.lvm');
cdata = import_155_data('counter.lvm');
%
...
%
analog_timestamp = datevec('13:57:48.08509');
counter_timestamp = datevec('13:57:48.25776');
